...
public class ValueSelectorElement extends GenericInteractableModernElement<ValueSelectorElement, Canvas, ValueSelectorElement.ValueSelectorElementListenerReferences> {
    ...
    private final ValueSelectorElementListenerReferences references = new ValueSelectorElementListenerReferences(this);
    ...
    @Override
    public @NotNull ValueSelectorElement.ValueSelectorElementListenerReferences listen() {
        return references;
    }
    ...
    public static final class ValueSelectorElementListenerReferences extends ListenerReferences<ValueSelectorElement, ValueSelectorElementListenerReferences> {
        private final ValueSelectorElement back;

        public ValueSelectorElementListenerReferences(ValueSelectorElement back) {
            this.back = back;
        }

        @Override
        public ValueSelectorElement back() {
            return back;
        }
